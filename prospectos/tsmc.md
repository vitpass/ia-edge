---
{
  "titulo": "Prospecto IA: TSMC (TSM)",
  "data": "2026-07-22",
  "slug": "tsmc",
  "ticker": "TSM",
  "empresa": "TSMC",
  "setor": "Tecnologia (fabricação de semicondutores)",
  "mercado": "NYSE/Taiwan",
  "meta_description": "Prospecto IA da TSMC (TSM): receita +33,7% no 2T26, tese do quase-monopólio dos chips avançados, riscos de Taiwan e como investir via BDR TSMC34.",
  "palavras_chave": ["tsmc", "tsm", "tsmc34", "bdr", "semicondutores", "chips de ia", "taiwan", "prospecto ia", "2nm", "hpc"]
}
---
...
Essa posição é quase um monopólio na prática. Nos processos mais avançados (7 nanômetros ou menos — quanto menor o número, mais denso e eficiente o chip), a TSMC concentra mais de 90% da capacidade mundial, segundo [análise da Verdantix](https://www.verdantix.com/client-portal/blog/war-games-and-wafers-the-semiconductor-industry-on-a-geopolitical-edge). Samsung e Intel tentam alcançar, mas seguem atrás em rendimento e escala.
...
Minha tese tem três pilares. Primeiro, a demanda por chips de IA continua maior que a oferta, e quem decide quem recebe capacidade é a TSMC. Segundo, a vantagem técnica se renova: o processo de 2nm entrou em produção em massa no fim de 2025 e cinco fábricas devem acelerar a produção em 2026, [o ritmo de expansão mais agressivo da história da empresa](https://technode.com/2026/04/29/tsmc-accelerates-2nm-expansion-as-ai-demand-surges-targets-record-five-fab-ramp-in-2026/). Terceiro, a empresa está comprando um seguro geográfico: são US$ 265 bilhões comprometidos no Arizona ([mais US$ 100 bilhões anunciados junto com o balanço](https://www.tomshardware.com/tech-industry/tsmc-commits-another-100-billion-to-arizona-for-at-least-four-more-2nm-fabs)), além de fábricas no Japão (Kumamoto) e na Alemanha (Dresden, focada em chips maduros para a indústria automotiva).

Sobre preço, uma pincelada só: a ação negociava a um P/L (preço dividido pelo lucro) de cerca de 36,5 em meados de julho, [o maior múltiplo da década para a empresa](https://fullratio.com/stocks/nyse-tsm/pe-ratio). Crescimento confirmado, mas pago a preço cheio.
...
Pelo BDR TSMC34, negociado na B3 em reais via qualquer corretora brasileira — é um recibo lastreado no ADR da NYSE, [com dados disponíveis no Investidor10](https://investidor10.com.br/bdrs/tsmc34/). Alternativa: comprar o ADR TSM direto por uma conta internacional.
