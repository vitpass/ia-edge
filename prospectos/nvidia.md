---
{
  "titulo": "Prospecto IA: Nvidia (NVDA)",
  "data": "2026-07-22",
  "slug": "nvidia",
  "ticker": "NVDA",
  "empresa": "Nvidia",
  "setor": "Tecnologia (semicondutores e IA)",
  "mercado": "Nasdaq (EUA)",
  "meta_description": "Analiso a Nvidia (NVDA): receita crescendo 85% ao ano com chips de IA, a tese, os riscos e como investir do Brasil pelo BDR NVDC34.",
  "palavras_chave": ["nvidia", "nvda", "nvdc34", "chips de ia", "semicondutores", "bdr", "data center", "blackwell", "rubin"]
}
---
...
Os dois últimos balanços contam a história. No quarto trimestre do ano fiscal 2026 (encerrado em janeiro), a receita foi de [US$ 68,1 bilhões, alta de 73% em um ano](https://nvidianews.nvidia.com/news/nvidia-announces-financial-results-for-fourth-quarter-and-fiscal-2026), com a divisão de data center respondendo por US$ 62,3 bilhões (+75%).

No trimestre seguinte, o primeiro do ano fiscal 2027 (encerrado em abril de 2026), a receita acelerou para [US$ 81,6 bilhões, alta de 85%](https://nvidianews.nvidia.com/news/nvidia-announces-financial-results-for-first-quarter-fiscal-2027). Data center: US$ 75,2 bilhões, crescimento de 92%. A margem bruta — o que sobra da receita depois do custo de produzir — ficou perto de 75%, patamar raríssimo em hardware. A projeção da empresa para o trimestre atual é de US$ 91 bilhões, e ela avisou que esse número não conta com nenhuma receita de chips de data center vindos da China.

Sobre preço: a ação vale mais de [US$ 5 trilhões em valor de mercado](https://finance.yahoo.com/sectors/technology/article/nvidia-stock-clinches-record-close-pushing-market-cap-over-5-trillion-once-again-173529477.html), a empresa mais valiosa do mundo. Pelo lucro projetado para os próximos doze meses, [o múltiplo caiu para a casa de 20 e poucas vezes](https://www.fool.com/investing/2026/07/11/nvidias-forward-pe-has-actually-fallen-as-its-stoc/) — o lucro cresce mais rápido que a ação.

## A tese: por que pode continuar

Minha tese tem três pilares. Primeiro, a demanda segue maior que a oferta: a geração atual de chips, a Blackwell, ficou praticamente vendida por antecipação, e a próxima, a Vera Rubin, [entrou em produção em junho de 2026](https://www.trendforce.com/news/2026/06/01/news-vera-rubin-buildout-nvidia-reportedly-pushes-tsmc-above-20-revenue-share-power-and-cooling-suppliers-benefit/), com entregas no segundo semestre. Segundo, a Nvidia garantiu a maior parte da capacidade de empacotamento avançado da TSMC, o gargalo físico do setor — quem controla o gargalo controla o ritmo. Terceiro, o CUDA e os equipamentos de rede transformam a venda de um chip na venda de um sistema inteiro, o que protege a margem.
...
- **Concentração de clientes.** Metade da receita de data center vem de poucas gigantes de nuvem. Se duas delas cortarem pedidos, o efeito é imediato.
- **China.** As restrições de exportação dos EUA já tiraram bilhões da receita, e a empresa hoje projeta zero vindo de lá. Qualquer aperto adicional em outros mercados seguiria o mesmo roteiro.
- **Concorrência.** A AMD já teria perto de 10% do mercado de aceleradores, e o Google [lançou novos chips TPU próprios](https://techcrunch.com/2026/04/22/google-cloud-next-new-tpu-ai-chips-compete-with-nvidia/) — os mesmos clientes gigantes estão desenhando os próprios chips para depender menos da Nvidia.
...
Pelo BDR [NVDC34, negociado na B3](https://www.suno.com.br/noticias/como-investir-nvidia-nvdc34-b3-bdr-mt/) em reais: cada ação da Nvidia corresponde a 48 BDRs. Lembre que o BDR embute a variação do dólar, para o bem e para o mal.
